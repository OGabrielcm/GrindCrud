...
while(true)
{
    ...
    void CadastrarConsulta()
    {
        ...
        string codigo;
        Console.WriteLine("codigo da consulta (ex: CONS0512): ");
    ...
    void CadastrarAgendamento()
    {
        ...
        while (!int.TryParse(Console.ReadLine(), out tipoNum) || tipoNum < 1 || tipoNum > 3)
            Console.WriteLine("tipo invalido, tente novamente");
        TipoAtendimentoEnum tipo = (TipoAtendimentoEnum)tipoNum;
